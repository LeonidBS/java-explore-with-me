...
public class EventPublicController {
    ...
    @GetMapping
    public List<EventShortPublicDto> getByFilters(@RequestParam(defaultValue = "") String text,
    ...
    @GetMapping("/{id}")
    public EventFullPublicDto getById(@PositiveOrZero @PathVariable Integer id,
                                      HttpServletRequest httpServletRequest) {
